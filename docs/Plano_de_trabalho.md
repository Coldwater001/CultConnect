...
2. [INFORMAÇÕES GERAIS](#2-informações-gerais)
   ...
   - 2.2 [Escopo Geral](#22-escopo-geral)
   - 2.3 [Ambiente de Desenvolvimento](#23-ambiente-de-desenvolvimento)
   - 2.4 [Características Inovadoras do Projeto](#24-características-inovadoras-do-projeto)
   - 2.5 [Resultados Esperados](#25-resultados-esperados)
3. [METODOLOGIA DE PROJETO](#3-metodologia-de-projeto)
   ...
   - 3.3 [Fases, Atividades e Cronograma](#33-fases-atividades-e-cronograma)
...
| Impacto Ambiental | O sistema aborda diversas práticas sustentáveis de desenvolvimento de software, promovendo a troca virtual de experiência cultural entre os usuários, o que faz reduzir a necessidade de viagens físicas, consequentemente, minimizando a emissão de carbono na atmosfera. |
| Ética | A plataforma estará em conformidade com os padrões éticos de privacidade e proteção de dados, seguindo regulamentações como o GDPR. Haverá transparência no uso de dados dos usuários e consentimento explícito será obtido para qualquer coleta de informações. |
| Segurança | A segurança dos dados dos usuários será uma prioridade, com a implementação de medidas robustas de segurança cibernética, incluindo criptografia de dados, autenticação de dois fatores e auditorias regulares de segurança. |

#### 1.3.3 Tipo
| Tipo | Detalhamento |
|------|--------------|
| Desenvolvimento de Software | O projeto é caracterizado como um Desenvolvimento de Software, voltado para a criação de uma plataforma (Frontend, Backend, Segurança e Privacidade, Escalabilidade). |
...
| Diagramação | Draw.io | Ferramenta utilizada para criar diagramas de arquitetura, incluindo o diagrama de classe, o diagrma de sequência e o modelo C4, que ajudam a visualizar a estrutura do sistema e os processos de desenvolvimento. |
...
- Plataforma Integrada: Combinação de múltiplas funcionalidades como o compartilhamento de culturas e histórias, aprendizado de idiomas e culinárias em um só lugar.   
...
- Planejamento: Definição dos requisitos e planejamento inicial.
- Design: Criação de personas, histórias de usuário, backlog do sprint e a criação dos diagramas.
- Desenvolvimento: Implementação das funcionalidades planejadas para cada sprint, se baseando nos diagramas criados pela equipe.
- Testes: Testes de usabilidade e correção de bugs.
- Entrega: Apresentação e documentação final do projeto.
...
|-------|-----|------------|
| I. Especificação | Maio/Junho | Requisitos do projeto, planejamento inicial e criação do plano de trabalho |
| II. Inspeção | Junho | Revisão dos artefatos |
| III. Projeto e Arquitetura | Junho | Criação de personas, histórias de usuário, backlog do sprint |
| IV. Prototipagem e Refinamento | Julho | Prototipagem de interface e refinamento das funcionalidades |
